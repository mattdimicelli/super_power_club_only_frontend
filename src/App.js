    ...
    const posts = [
        {
          ...
          "author": {
            ...
            "member": false,
            "hashedPassword": "$2a$10$erOaTncwjC/wZPeYJy2nbutdJATCFqO3JU2F2hzKUjOzalve/GhVS",
            "avatar": "link",
            "admin": true,
            "__v": 0
          },
        ...
        },
        {
          ...
          "author": {
            ...
            "member": false,
            "hashedPassword": "$2a$10$z8SCWGgIxkkT0AAEDSuQ.eWyWtEAvR2lLtRrTUh5y4gr.wOt0e37S",
            "avatar": "peach",
            "admin": false,
            "__v": 0
          },
        ...
        },
        {
          ...
          "author": {
            ...
            "member": true,
            "hashedPassword": "$2a$10$W3djNB.WxZ0vmtoB8ImciOQM93645v0dwJw45I0fUb.Hrrxhr62gG",
            "avatar": "fox",
            "admin": false,
            "__v": 0
          },
      ...
      const postList = posts.map(post => <Post post={post} isLoggedIn={true} isAdmin={false} />);
